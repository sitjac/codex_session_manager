...
Examples of representing our project include using an official project e-mail
...
maintainers through a private channel if one is available. If there is no
private reporting channel listed yet, open a minimal issue requesting a private
contact path without disclosing sensitive details publicly.
